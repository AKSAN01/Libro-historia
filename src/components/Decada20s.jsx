...
export const Decada20s = () => {
  ...
  return (
    <motion.div
      className="notih-root library-bg theme-20s"
        ...
        <div className="notih-page notih-page--left">
          ...
          <div className="notih-page-content">
            <div className="notih-header">
              <Link to="/" className="notih-back-link">
                ← Volver a la estantería
              </Link>
              <span className="notih-chapter-label">CAPÍTULO 7</span>
              <h1 className="notih-chapter-title">2020 — 2026</h1>
              <h2 className="notih-chapter-subtitle">Pandemia, estallido social y cambio político</h2>
            </div>
            {/* ── MACBOOK ── */}
              ...
              <div className="notih-ficha-body">
                ...
                {activeHito ? (
                  activeHito.fichaLineas.map((l, i) => (
                    <div key={i} className="notih-ficha-linea">
                      <span className="notih-ficha-linea-text">{l}</span>
                    </div>
                  ))
                ) : (
                  <div className="notih-ficha-empty">Selecciona un hito para ver la ficha</div>
                )}
              </div>
            </div>
          </div>
              ...
              <div className="notih-script-body">
                <AnimatePresence mode="wait">
                  {activeHito ? (
                    ...
                    >
                      <h3 className="notih-script-headline">
                        {activeHito.year} — {activeHito.title}
                      </h3>
                      {activeHito.guion.split('\n\n').map((para, i) => (
                        <p
                          key={i}
                          className={i === 0 ? 'notih-script-para notih-script-para--header' : 'notih-script-para'}
                        >
                          {para}
                        </p>
                      ))}
